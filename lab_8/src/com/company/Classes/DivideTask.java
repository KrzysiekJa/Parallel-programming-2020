...
public class DivideTask extends RecursiveTask<int[]> {
    ...
    protected int[] compute() {
        ...
        DivideTask task1 = new DivideTask(Arrays.copyOfRange(arrayToDivide, 0, mid));
        DivideTask task2 = new DivideTask(Arrays.copyOfRange(arrayToDivide, mid, arrayToDivide.length));
